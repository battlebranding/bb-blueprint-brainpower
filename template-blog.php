				...
				<div class="column is-two-thirds has-large-padding">
					<?php if ( $posts->have_posts() ) : while ( $posts->have_posts() ) : $posts->the_post(); ?>
						<article class="has-small-padding">
							<a href="<?php the_permalink(); ?>"><div class="thumbnail" style="background-color: #333; width: 100%; height: 200px; background-image: url('<?php the_post_thumbnail_url(); ?>'); margin-bottom: 20px; background-size: cover; background-position: center;"></div></a>
							<h3><?php the_title(); ?></h3>
							<?php the_excerpt(); ?>
